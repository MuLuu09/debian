...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/56.conf $source/debian7/56.conf
...
cd /etc/openvpn/
wget -O /etc/openvpn/56tcp.ovpn $source/debian7/56-client.conf

cp /etc/openvpn/client.ovpn /home/vps/public_html/56tcp.ovpn
sed -i $myip2 /home/vps/public_html/56tcp.ovpn
sed -i "s/ports/55/" /home/vps/public_html/56tcp.ovpn
